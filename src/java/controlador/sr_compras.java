...
public class sr_compras extends HttpServlet {
 ...
 /*java.sql.Date sqlDate = new java.sql.Date(utilDate.getTime()); */
            compras = new Compras(Integer.valueOf(request.getParameter("id_compra")), Integer.valueOf(request.getParameter("no_orden_compra")), Integer.valueOf(request.getParameter("id_proveedor")), (java.sql.Date) fecha, (java.sql.Date) fecha);
