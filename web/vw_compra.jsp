...
<html>
    ...
    <body>
        ...
        <br>
        <button type="button" name="btn_nuevo" id="btn_nuevo" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modal_compra_detalle" onclick="limpiarDetalle()">Agregar Detalle</button>
        ...
        <div class="container">
            ...
            <div class="modal fade" id="modal_compra_detalle" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <form action="sr_compra_detalle" method="post" class="form-group">
